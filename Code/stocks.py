# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 19:46:55 2017
...
def Main(args):
    ...
    R = MLPR(layers, maxItr = 1000, tol = 0.01, reg = 0.001, verbose = True)
...
if __name__ == "__main__":
    #Main(sys.argv[1:])
    p, n = Main([r'C:\Users\Dell\Documents\Python Scripts\relstock.csv', '2017-03-01', '2017-06-30', 'D'])